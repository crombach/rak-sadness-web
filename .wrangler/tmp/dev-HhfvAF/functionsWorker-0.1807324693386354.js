// .wrangler/tmp/bundle-un4yWB/checked-fetch.js
...
// .wrangler/tmp/pages-ntwY0g/functionsWorker-0.1807324693386354.mjs
...
// .wrangler/tmp/bundle-un4yWB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-un4yWB/middleware-loader.entry.ts
...
function getMaskedEnv2(rawEnv) {
  let env = rawEnv;
  if (
    middleware_insertion_facade_default2.envWrappers &&
    middleware_insertion_facade_default2.envWrappers.length > 0
  ) {
...
var facade4 = {
  ...
  fetch(request, rawEnv, ctx) {
    ...
    if (
      middleware_insertion_facade_default2.middleware &&
      middleware_insertion_facade_default2.middleware.length > 0
    ) {
      ...
      const __facade_modules_dispatch__ = function (type, init) {
        if (
          type === "scheduled" &&
          middleware_insertion_facade_default2.scheduled !== void 0
        ) {
          ...
          return middleware_insertion_facade_default2.scheduled(
            controller,
            env,
            ctx,
          );
...
//# sourceMappingURL=functionsWorker-0.1807324693386354.js.map
